...
| Type | Default value |
|-     |-
| bool | {ref}`${isCIBuild}<isCIBuild>`<br> <br>*<span style="color:orange">Changed in version 1.1.0</span>* -- Previous value was directly resolved by {py:class}`nmk_base.git.CIResolver`
