...
| Type      | Default value                                                                                                                          |
| --------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| list[str] | [ "${PROJECTDIR_NMK}/", "{ref}`${outputDir}<outputDir>`", "{ref}`${venvName}<venvName>`", "{ref}`${buildenvFolder}<buildenvFolder>`" ] |
...
| Type | Default value                                                                                                                                                                      |
| ---- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| bool | {ref}`${isCIBuild}<isCIBuild>`<br> <br>_<span style="color:orange">Changed in version 1.1.0</span>_ -- Previous value was directly resolved by {py:class}`nmk_base.git.CIResolver` |
...
| Type      | Default value                                                                                                                                                                                         |
| --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| list[str] | **[${PACKAGESREFS}](https://nmk.readthedocs.io/en/stable/file.html#built-in-config-items)**<br> <br>_<span style="color:orange">Changed in version 1.0.1</span>_ -- Previous value was `["nmk-base"]` |
...
| Type | Default value                                                                                                                                                       |
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| str  | Resolved by {py:class}`nmk_base.backends.VenvNameResolver`<br> <br>_<span style="color:orange">Changed in version 1.2.0</span>_<br>Previous static value was "venv" |
...
| Type | Default value                                              |
| ---- | ---------------------------------------------------------- |
| str  | Resolved by {py:class}`nmk_base.backends.VenvRootResolver` |
...
| Type | Default value                                              |
| ---- | ---------------------------------------------------------- |
| str  | ${PROJECTDIR}/{ref}`${venvRequirements}<venvRequirements>` |

Overridable input file pointer for {ref}`py.venv<py.venv>` task.
...
| Type | Default value                                                             |
| ---- | ------------------------------------------------------------------------- |
| bool | Generated by {py:class}`nmk_base.backends.BackendUseRequirementsResolver` |
...
| Type | Default value                                                    |
| ---- | ---------------------------------------------------------------- |
| bool | Generated by {py:class}`nmk_base.backends.BackendLegacyResolver` |
...
| Type | Default value                                                     |
| ---- | ----------------------------------------------------------------- |
| str  | Generated by {py:class}`nmk_base.backends.BuildenvFolderResolver` |
...
| Type | Default value                                                                                                                                  |
| ---- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| str  | "{ref}`${backendLegacy}<backendLegacy>`"<br> <br>_<span style="color:orange">Changed in version 1.2.0</span>_ Previous static value was `True` |

Enablement condition for **{ref}`buildenv<buildenv>`** task.
...
| Type | Default value                                               |
| ---- | ----------------------------------------------------------- |
| str  | Generated by {py:class}`nmk_base.resolvers.CommandResolver` |

Resolves the **java** command, from provided custom path (in {ref}`${javaRuntimeCustomPath}<javaRuntimeCustomPath>`) or from system path.
