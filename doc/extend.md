...
If any **`nmk`** project aims to use a custom **java** runtime instead of the system one, it may override the **{ref}`javaRuntimeCustomPath<javaRuntimeCustomPath>`** to define this path.
